...
import com.example.androidmyrestaurant.Utils.SpaceItemDecoration;
...
public class MenuActivity extends AppCompatActivity  {
    ...
    public void loadMenuByRestaurant(MenuItemEvent event)
    {
        if (event.isSuccess())
        {
            ...
            Toast.makeText(this, "[RESTAURANT LOAD]"+event.getRestaurant().getId(), Toast.LENGTH_LONG).show();
        }
        //dialog.dismiss();
    }
}
