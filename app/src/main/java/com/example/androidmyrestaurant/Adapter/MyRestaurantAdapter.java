...
public class MyRestaurantAdapter extends RecyclerView.Adapter<MyRestaurantAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.setListener((view, position1) -> {
           ...
           // Toast.makeText(context, ""+restaurantList.get(position1).getName()+restaurantList.get(position).getId(), Toast.LENGTH_SHORT).show();
            //here use use poststicky , that mean this event will be listen from other activity
